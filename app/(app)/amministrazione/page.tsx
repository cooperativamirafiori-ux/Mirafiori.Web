      ...
      <main className="flex-1 px-4 py-6 max-w-3xl mx-auto w-full">
        ...
        <section className="grid grid-cols-1 sm:grid-cols-2 gap-4">
          ...
          >
            ...
            <h3 className="mt-4 font-bold text-gray-800 text-lg">Gestione Password</h3>
            <p className="text-sm text-gray-500 mt-1">
              Credenziali dei portali: utente, password, PIN e numero per la verifica
            </p>
            <span className="mt-4 inline-flex items-center gap-1 text-sm font-semibold text-slate-700 group-hover:gap-2 transition-all">
              Apri →
            </span>
