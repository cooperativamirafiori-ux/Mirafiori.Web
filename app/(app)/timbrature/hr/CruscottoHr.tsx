...
export default function CruscottoHr() {
  const now = new Date()
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      <div className="bg-primary text-white px-5 py-4">
        <Link href="/timbrature" className="text-white/70 text-sm hover:text-white">← Timbrature</Link>
        <h1 className="text-lg font-bold">Cruscotto Timbrature — HR</h1>
      </div>
