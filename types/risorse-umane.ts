...
export const AREA_ASSUNZIONE = ['Area A', 'Area B'] as const
...
export const DIPENDENTI_FIELDS: readonly RUField[] = [
  ...
  { key: 'AreaAssunzione', label: 'Area di assunzione', type: 'choice', choices: AREA_ASSUNZIONE, section: 'Rapporto di lavoro' },
  ...
  { key: 'InvalidoSvantaggiato', label: 'Invalido civile / svantaggiato', type: 'choice', choices: SINO, section: 'Svantaggio e fondo' },
  { key: 'TipologiaSvantaggio', label: 'Tipologia invalidità / svantaggio', type: 'choice', choices: TIPOLOGIA_SVANTAGGIO, section: 'Svantaggio e fondo' },
  { key: 'FondoCoopersalute', label: 'Fondo Coopersalute', type: 'text', section: 'Svantaggio e fondo' },
